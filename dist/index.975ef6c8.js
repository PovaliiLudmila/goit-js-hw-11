...
var _addImages = require("./js/addImages");
var _makeGallery = require("./js/makeGallery");
var _getRefs = require("./js/getRefs");
(0, _getRefs.showSpinner)();
window.addEventListener("load", ()=>{
    console.log("All resources loaded!");
    (0, _getRefs.hideSpinner)();
});
...
async function onSearchForm(evt) {
    ...
    (0, _getRefs.showSpinner)();
    if (!currentQuery) return (0, _notiflixNotifyAio.Notify).info("Please enter a search keyword!");
    try {
        const response = await (0, _addImages.addImages)(currentQuery, pageNumber, per_page);
        ...
        if (images.length === 0) {
            ...
            (0, _makeGallery.makeGallery)(images);
            lightbox.refresh();
        ...
        console.log(error);
        (0, _notiflixNotifyAio.Notify).failure("Oops, something went wrong. Please try again later.");
    } finally{
        refs.form.reset();
        (0, _getRefs.hideSpinner)();
    }
...
async function onLoadMore() {
    ...
    if (pageNumber > totalPages) return (0, _notiflixNotifyAio.Notify).info("We're sorry, but you've reached the end of search results.");
    try {
        (0, _getRefs.showSpinner)();
        const response = await (0, _addImages.addImages)(currentQuery, pageNumber, per_page);
        const images = response.data.hits;
...
const onEntry = (entries)=>{
    entries.forEach((entry)=>{
        if (entry.isIntersecting && currentQuery !== "") onLoadMore();
    });
};
const options = {
    rootMargin: "200px"
...
window.addEventListener("scroll", ()=>{
    if (document.documentElement.scrollTop > 200) scrollTopBtn.style.display = "block";
...
},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix/build/notiflix-notify-aio":"eXQLZ","./js/makeGallery":"64gp0","./js/getRefs":"l246D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/addImages":"8bviD"}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"64gp0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeGallery", ()=>makeGallery);
...
},{}],"l246D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./getRefs":"l246D"}],"8bviD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addImages", ()=>addImages);
